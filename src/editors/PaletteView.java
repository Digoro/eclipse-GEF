...
public class PaletteView extends PaletteViewCreator{
	...
	public PaletteRoot createPaletteRoot(){
		...
		CombinedTemplateCreationEntry term = new CombinedTemplateCreationEntry("Terminator", "Start of End Component",null, AbstractUIPlugin.imageDescriptorFromPlugin("com.swtface.flowchart", "icons/tables.gif"), 
				AbstractUIPlugin.imageDescriptorFromPlugin("com.swtface.flowchart", "icons/realtions.gif"));
		entries.add(term);
